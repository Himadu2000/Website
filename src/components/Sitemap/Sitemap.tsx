    ...
    return (
      <>
        <div className='chat-padding'>
          ...
          <MDBContainer header='Animated' className='Site2'>
            <MDBCol md='4'>
              <MDBTreeview
                theme='colorful'
                header='WordPress'
                className='border-secondary w-20 '
                getValue={value => console.log(value)}>
                <MDBTreeviewItem icon='desktop' title='Home' />
                <MDBTreeviewItem icon='trash-alt' title='Pages' />
              </MDBTreeview>
            </MDBCol>
          </MDBContainer>
          <MDBContainer header='Animated' className='Site3'>
            <MDBCol md='4'>
              <MDBTreeview
                theme='colorful'
                header='Pages'
                ...
                getValue={value => console.log(value)}>
                <MDBTreeviewItem icon='desktop' title='Home' />
                <MDBTreeviewItem icon='trash-alt' title='Empty' />
              </MDBTreeview>
            </MDBCol>
          </MDBContainer>
          <MDBContainer header='Animated' className='Site4'>
            <MDBCol md='4'>
              <MDBTreeview
                theme='colorful'
                header='Media'
          ...
          <MDBContainer header='Animated' className='Site5'>
            <MDBCol md='4'>
              <MDBTreeview
                theme='colorful'
                header='Chat'
                ...
                getValue={value => console.log(value)}>
                <MDBTreeviewItem icon='desktop' title='Home' />
                <MDBTreeviewItem icon='desktop' title='User' />
                <MDBTreeviewItem icon='trash-alt' title='Chat' />
              </MDBTreeview>
            </MDBCol>
          </MDBContainer>
        </div>
