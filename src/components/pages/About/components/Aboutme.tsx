...
const AboutMe = () => (
  <>
    <p>
      ...
      page with react and beautiful with MDBReact.And after that I didint do
      much until July and then I started to learn more like backend and other
      things today when I write this 2019/09/10 at 08p.m. I learned lot and I
      liked web devoloping very much and authentication and JWT ,now a days I
      starting to working with firebase that is very useful. But arounnd these
      days I'm very busy.
    </p>
  </>
)
